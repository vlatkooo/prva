...
public class MojAdapter extends BaseAdapter {
	...
	public MojAdapter(Context ctx, String[] iminja) {
		this.ctx = ctx;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (s.startsWith("ЕМУ")) { hol.slika.setImageResource(R.drawable.eu_flag);}
		else if (s.startsWith("С А Д")) {hol.slika.setImageResource(R.drawable.usa_flag);}
		else if (s.startsWith("В.Британија")) {hol.slika.setImageResource(R.drawable.gb_flag);}
		else if (s.startsWith("Швајцарија")) {hol.slika.setImageResource(R.drawable.swiss_flag);}
